...
Source0  : https://poppler.freedesktop.org/poppler-data-0.4.11.tar.gz
Source1  : https://poppler.freedesktop.org/poppler-data-0.4.11.tar.gz.sig
...
%prep
%setup -q -n poppler-data-0.4.11
cd %{_builddir}/poppler-data-0.4.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631027289
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/poppler-data-0.4.11/COPYING %{buildroot}/usr/share/package-licenses/poppler-data-clr-rename/86b5d7e4afc7594e53b1481438d09c6103891755
cp %{_builddir}/poppler-data-0.4.11/COPYING.adobe %{buildroot}/usr/share/package-licenses/poppler-data-clr-rename/4842b9aa2b376ba8ebd197bb21a5ba06c3bd43b0
cp %{_builddir}/poppler-data-0.4.11/COPYING.gpl2 %{buildroot}/usr/share/package-licenses/poppler-data-clr-rename/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
pushd clr-build
%make_install
popd
